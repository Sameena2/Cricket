...
var Timer = /** @class */ (function () {
    ...
    Timer.prototype.countdown = function () {
        ...
        //let generate=document.getElementById("result")
        //generate.addEventListener("click",this.generate_results())
    };
    Timer.prototype.generate_results = function () {
        var _this = this;
        return function () {
            var s1 = parseInt(document.getElementById("total1").innerText);
            var s2 = parseInt(document.getElementById("total2").innerText);
            var winner_team = 0;
            if (s1 == s2) {
